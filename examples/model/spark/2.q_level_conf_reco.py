...
from utils.model.parameters import set_data_params, DEFAULT_DEVICE
...
mp = ModelProxy(model_name, ckp_path, minmax_dict["obj"], DEFAULT_DEVICE, op_groups, n_op_types)
...
PickleUtils.save({
    ...
    "objs_e2e": objs
}, f"{out_header}/{tid}-{qid}", f"po_results_{n_samples}.pkl")
