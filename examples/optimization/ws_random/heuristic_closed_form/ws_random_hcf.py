...
#
# Description: An example of running Weighted Sum with Random-Sampler solver
#
...
HELP = """
Format: python ws_random_hcf.py -c <config> -h
    - c : The configuration file location. Default is "examples/optimization/ws_random/heuristic_closed_form/configs.json"
Example:
    python examples/optimization/ws_random/heuristic_closed_form/ws_random_hcf.py -c examples/optimization/ws_random/heuristic_closed_form/configs.json
"""
