...
query="9 1"
conf="16g 5 4 40 48m 200 true 0.6 64MB 0.2 0b 10MB 200 256MB 5.0 128MB 4MB 0.2 1MB"
name="unnamed"
xpath="./outs"
verbose_mode=false
...
-b $benchmark -t ${tid} -q ${qid} -s 100 -x ${xpath} -l ${qpath}/resources/${benchmark}-kit/spark-sqls -v false
