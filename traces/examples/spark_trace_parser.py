...
DF1 (q.csv)
appid, tid, qid, lqp_id, lqp(json), im-1, im-2, pd(a list object), ss-1, ss-2, ..., ss-8, k1,...,k8,s1,...,s9, lat, io

DF2 (qs.csv)
appid, tid, qid, qs_id, qs_lqp(json), qs_pqp(json), initial_part_size, im-1, im-2, pd(a list object), ss-1, ss-2, ..., ss-8, k1,...,k8,s1,...,s9, ana_lat, io
...
if __name__ == '__main__':
    ...
    parser.add_argument('--header', type=str, default='./spark_collector/tpch100/lhs_22x2273')
